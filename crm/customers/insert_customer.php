    ...
    $( "#form" ).on( "submit", function(e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                if(data=='customer_already_created') {
                    $('#toast_pro').show();
                    $('#toast_pro').append('<div class="col-md-8"></div><div class="col-md-4 toast" ><label>Customer Already Created</label></div>');
                }
                else if(data=='customer_created') {
                    $('#toast_pro2').show();
                    $('#toast_pro2').append('<div class="col-md-8"></div><div class="col-md-4 toast" ><label>Customer Inserted</label></div>');
