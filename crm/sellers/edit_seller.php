...
<div class="container">
    ...
    <form method="post" action="server.php" enctype="multipart/form-data">
        ...
        <input value="<?php echo $s_name ?>" id="sellercompanyname" type="text" class="form-control"
               placeholder="Enter Seller/Company Name" name="sellername"><br>
        ...
        <?php
        $s_dealer = "select * from seller_dealer where seller_id='$s_id'";
        $row_dealer = mysqli_query($conn, $s_dealer);
        if (mysqli_num_rows($row_dealer) > 0) {
            while ($get_dealer = mysqli_fetch_assoc($row_dealer)) {
                $s_dealer_name = $get_dealer['s_dealer_name'];
                $s_dealer_contact = $get_dealer['s_contact_number'];
                $s_dealer_account = $get_dealer['s_account_number'];
                echo '<div id="myRepeatingFields4" >
            <div class="entry input-group col-xs-3">
                <div class="row">
                    <div class="col">
                        <label for="dealers">Enter Dealer Name</label>
                        <input id="dealers" name="s_dealer_name[]" value="'.$s_dealer_name.'" type="text" placeholder="Enter Dealer Name" class="form-control">
                    </div>
                    <div class="col">
                        <label for="contactnum">Contact Number</label>
                        <input name="s_dealer_contact[]" value="'.$s_dealer_contact.'" id="contactnum" type="text" placeholder="Enter Contact Number" class="form-control">
                    </div>
                    <div class="col">
                        <label for="accnum">Account Number</label>
                        <input name="s_dealer_account[]" value="'.$s_dealer_account.'" id="accnum" type="text" placeholder="Enter Account Number" class="form-control" >
                    </div>
                    <div style="max-width: 5%!important; margin-top: 25px;" class="col">
                        <button type="button" class="btn btn-success btn-lg btn-add4">
            ...
            <div class="entry input-group col-xs-3">
                <div class="row">
                    <div class="col">
                        <label for="dealers">Enter Dealer Name</label>
                        <input id="dealers" name="s_dealer_name[]" type="text" placeholder="Enter Dealer Name" class="form-control" >
                    </div>
                    <div class="col">
                        <label for="contactnum">Contact Number</label>
                        <input name="s_dealer_contact[]" id="contactnum" type="text" placeholder="Enter Contact Number" class="form-control">
                    </div>
                    <div class="col">
                        <label for="accnum">Account Number</label>
                        <input name="s_dealer_account[]" id="accnum" type="text" placeholder="Enter Account Number" class="form-control" >
                    </div>
                    <div style="max-width: 5%!important; margin-top: 25px;" class="col">
                        <button type="button" class="btn btn-success btn-lg btn-add4">
                            <i class="fa fa-plus" aria-hidden="true"></i>
            ...
            <div id="myRepeatingFields5">
                <div class="entry input-group col-xs-3">
                        ...
                        while ($get_inactiveprice = mysqli_fetch_assoc($row_inactiveprice)) {
                            $pro_inactive_id = $get_inactiveprice['id'];
                            $pro_inavtive_name = $get_inactiveprice['name'];
                        ...
                        $phone_inactive_pro = $get_inactiveprice['inactive_pro_phone'];
                            ...
                            <select id="seller_otherproduct" name="seller_otherproduct[]"class=" form-control">
                                <option value="'.$pro_inactive_id.'" selected> '.$pro_inavtive_name.'</option>';?>
                                <?php
    ...
    echo'<div class="col">
                         ...
                         <div class="col">
                            <label for="pdate">Enter phone</label>
                            <input id="pdate" name="seller_otherproduct_phone[]" type="text" placeholder="Enter Phone Number" class="form-control" value="">
                        </div>
                        <div style="max-width: 5%!important; margin-top: 25px;" class="col">
                            <button type="button" class="btn btn-success btn-lg btn-add5">
                                <i class="fa fa-plus" aria-hidden="true"></i>
...
<br>
        ...
        <div class="row"><!--- row 3 --->
            ...
            <div style="padding: 0; padding-left: 10px" class="col">
                ...
                <textarea id="sellerdescription" class="form-control" placeholder="Enter Description" rows="8"
                          name="s_description"><?php echo $s_des ?></textarea><br>
        ...
        <div class="row">
            <div style="padding: 0px" class="col">
                ...
                <input value="<?php echo $s_cat ?>" type="text" id="dealercat" class="form-control" name="dealer_cat"
    ...
    $(document).ready(function () {
        ...
        $('#sellertype').change(function () {
            ...
            if (seller_type == '1') {
                ...
                $('#choose_product').css("display","none");
            }
            else {
                $('#choose_product').css("display","block");
