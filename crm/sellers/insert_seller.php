    ...
    $( "form" ).on( "submit", function(e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                if(data=='seller_already_created') {
                    $('#toast_pro').show();
                    $('#toast_pro').append('<div class="col-md-8"></div><div class="col-md-4 toast" ><label>Seller Already Created</label></div>');
                }
                else if(data=='seller_insert') {
                    $('#toast_pro2').show();
                    $('#toast_pro2').append('<div class="col-md-8"></div><div class="col-md-4 toast" ><label>Seller Created</label></div>');
