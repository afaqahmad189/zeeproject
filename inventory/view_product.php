...
$sql = "select * from category c,add_product p where p.id=$p_id and c.id=p.cat_id";
            ...
            <div style="padding: 10px;   height: 850px; " class="card fixedcard">
                ...
                <center>
                    ...
                    if ($main_pic == 'products/') {
                        echo '<img align="center" width="180px" height="170px" src="products/No-image-available.png"><br></center><br>';
                    } else {
                        echo '<img align="center" width="180px" height="170px"src="' . $main_pic . '"><br></center><br>';
                    }
                    ?>
                    ...
                    <table class="table text-center">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php echo $product_cost . '&nbspRs'; ?>

                            </td>

                            <td>

                                <?php echo $p_price . '&nbspRs'; ?>
                    ...
                    <a href="edit_product.php?product_id=<?php echo $p_id; ?>"
                       style="font-size: 24px; margin-bottom: 8px;color: white"
                       class="btn btn-primary viewpagebtn">Edit</a>
        ...
        <div class="col-md-8 col-sm-12">
            <div style="padding: 20px; margin-left: 15px" class="card ">
                ...
                <div class="row">
                    ...
                    $image_other = "select * from product_images where product_id='$p_id' order by pro_other_img limit 3";
					...
					<center><img align="center" width="180px" height="170px" src="' . $data_other1 . '"></center></div>';
                        ...
                        echo '<div class="col-md-4">
					<center>
					<img align="center" width="180px" src="products/No-image-available.png"></center></div>
					<div class="col-md-4">
                ...
                <center><h4>Purchase Info</h4></center>
                <br>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <center>
                            <button style="width:60%; margin-left: -5px" class="btn btn-primary" data-toggle="modal"
                                    data-target="#printingkhata">Choose Date
                            </button>
                            <br></center>


                        <!-- Modal -->
                        <div class="modal fade" id="printingkhata" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <label style="color: black!important" for="startdate">Starting
                                                    Date</label>
                                                <input id="startdate" type="date" class="form-control"
                                                       placeholder="Enter Date" name=""><br>
