	...
	<div class="row"> 
		...
		<div style="padding: 10px; max-width: 30%" class="col card ">
			...
			<center>
				...
				<h1 style="margin-bottom: 20px"><?php echo $shopname?></h1>
                <?php
                if($cus_img=='images/'){
...
<!--				</tr>	-->
		...
		<a style=" font-size: 24px; margin-bottom: 12px" class="btn btn-primary viewpagebtn" href="/zeeproject/crm/customers/edit_customer.php?customer_id=1">Edit Customer</a>	
		...
		<div style="padding: 20px; margin-left: 15px" class="col card ">
			...
			<center><h4>Customer Latest Orders</h4></center>
